...
function funcaoMuitoPesada() {
  var execucoes = 0; // Inicializa a variável de contagem de execuções
  for (var i = 0; i < 1000000000; i++) {
    // Loop que itera um bilhão de vezes
...
var promiseComParametros = function promiseComParametros(login, senha) {
  return new Promise(function (resolve, reject) {
    setTimeout(function () {
      ...
      resolve("Logado com o usu\xE1rio: ".concat(login, ".")); // Resolve a Promise com a mensagem de login
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 5:
          ...
          // Aguarda o resultado da Promise
        ...
        case 9:
          ...
          console.log(_context.t0); // Exibe o erro se houver falha na Promise
        case 12:
