...
console.log(meuMap);
var nome = meuMap.get("nome"); //aponta para um conteudo especifico do map
console.log(nome);
...
try {
  for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
    ...
    //recupera todas as entradas do map
    console.log(entrada);
  }
} catch (err) {
  _iterator3.e(err);
...
try {
  for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
    ...
    //recupera o map separadamente em forma de string
...
var array = ['gian souza', 'luis henri', 'maria isabel', 'gian souza', 'luis henri'];
var arrayComoSet = new Set([].concat(array)); //set remove duplicatas
var arraySemDuplicatas = _toConsumableArray(arrayComoSet); //transformando set para array
